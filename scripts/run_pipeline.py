...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--dry-run-fetch", action="store_true", help="Send the Flex request without polling or saving the statement.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = run_pipeline(settings=settings, dry_run_fetch=args.dry_run_fetch)
